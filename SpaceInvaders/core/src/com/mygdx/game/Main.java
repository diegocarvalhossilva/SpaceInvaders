...
public class Main extends ApplicationAdapter {
	...
	public void render () {
		...
		case MENU: /*Menu do jogo*/
			...
			batch.begin();
			font.draw(batch, "SPACE INVADERS", 300, 400);
			font.draw(batch, "APERTE A TECLA ESPAÇO PARA INICIAR!!", 250, 300);
			batch.end();
		...
		case END: /*Tela de derrota*/
			...
			font.draw(batch, "APERTE A TECLA ESPAÇO PARA VOLTAR AO MENU!!", 200, 300);
			batch.end();
	...
	public void setEstadoAtual(GameState estadoAtual) {
